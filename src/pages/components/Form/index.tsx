        ...
        <>
            <div className="search-container">
                ...
                <div className="search-button">
                    <button value="Encontrar" type="submit" onClick={handleOnClick} >
                        Encontrar
                    </button>
                </div>
            </div>
            ...
            <div className="search-result-container">
                 ...
                 <div className="result-info-container">
                     <div>Repositórios públicos: <span>{userResponse?.public_repos}</span></div>
                     <div>Seguidores: <span>{userResponse?.followers}</span></div>
                     <div>Seguindo: <span>{userResponse?.following}</span></div>
                 </div>
